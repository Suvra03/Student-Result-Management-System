            ...
            if (mysqli_num_rows($result) == 0) {
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-sm btn-primary" href="view_notice.php?nid=<?php echo htmlentities($row["id"]); ?>"
                      target="_blank" style="background-color: green; border-color: black;">View Document</a>
                  </td>
                </tr>
                <?php
              }
