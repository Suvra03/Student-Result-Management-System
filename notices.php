...
<html lang="en">
  ...
  <h5 style="padding-top: 50px; padding-bottom: 0px; padding-left: 5%;">Notices- </h5><br>
    ...
    <footer class="footer mt-auto">
      <div class="text-white" style="font-size: 15px; background-color: rgb(28, 26, 26); ">
        <div class="container" style="border: none; width: 2000px; padding-top: 50px; padding-bottom: 50px;">
          <div class="row">
