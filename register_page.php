...
<body>
    ...
    <header class="container-fluid" style="background-color: rgb(10, 37, 95); color: #fff;">
        <div class="row custom-container">
            ...
            <div class="col" style="text-align: center; padding-top: 20px; padding-left: 0px;">
                ...
                <h8 style="display: inline-block; width: 800px; padding-bottom: 20px; font-size: smaller;">Affilliated
                    to Gauhati University, Assam</h8>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-5">
                    ...
                    <label>
                        <input type="radio" name="citizen" value="YES" id="citizenYes" onclick="handleCitizenSelection()" style="width: 30px;" required>Yes
                    </label>
                    <label>
                        <input type="radio" name="citizen" value="NO" id="citizenNo" onclick="handleCitizenSelection()" style="width: 30px;" required>No
                    </label>
                </div>
                <div class="col-5">
        ...
        <div class="container">
            ...
            <div class="col-10">
                ...
                <select class="form-control" id="selectCourse" name="semester" required>
                    <option value="default">Select Your Semester</option>
    ...
    <footer class="footer">
        <div class="text-white" style="font-size: 15px; background-color: rgb(28, 26, 26); ">
            <div class="container-fluid" style="border: none; padding-top: 50px; padding-bottom: 50px; width: 1300px; padding-left: 0px;">
                <div class="row">
