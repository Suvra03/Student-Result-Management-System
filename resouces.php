...
<html lang="en">
  ...
  <!-- ---- Navbar starts from here ---- -->
    ...
    <h5 style="padding-top: 50px; padding-bottom: 20px; padding-left: 5%;">Resources-</h5><br>
      <div class="container">
        <div class="card">
        <!-- BCA starts here -->
          ...
          <div id="bcaContent" class="collapse">
            <div class="card-body">
              <div class="container">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>Subjects for 1st Semseter</th>
            ...
            <div class="card-body">
              <div class="container">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>Subjects for 2nd Semseter</th>
                      <th>Reference Books</th>
                      <th>Previous Year Question Papers</th>
                    </tr>
                  </thead>
            ...
            <div class="card-body">
              <div class="container">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>Subjects for 3th Semseter</th>
                      <th>Reference Books</th>
                      <th>Previous Year Question Papers</th>
                    </tr>
                  </thead>
            ...
            <div class="card-body">
              <div class="container">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>Subjects for 4th Semseter</th>
                      <th>Reference Books</th>
                      <th>Previous Year Question Papers</th>
                    </tr>
                  </thead>
            ...
            <div class="card-body">
              <div class="container">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>Subjects for 5th Semseter</th>
                      <th>Reference Books</th>
                      <th>Previous Year Question Papers</th>
                    </tr>
                  </thead>
            ...
            <div class="card-body">
              <div class="container">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>Subjects for 6th Semseter</th>
                      <th>Reference Books</th>
                      <th>Previous Year Question Papers</th>
                    </tr>
                  </thead>
            ...
            <div class="card-body">
              <div class="container">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>Subjects for 3rd Semseter</th>
                      <th>Reference Books</th>
                      <th>Previous Year Question Papers</th>
                    </tr>
                  </thead>
        ...
        <!-- BSC-CS starts here -->
        <div class="card">
          <div class="card-header" data-toggle="collapse" data-target="#bsccsContent" style="background-color: rgb(28, 26, 26); color: white; height: 40px;">
            <p>CSC(Bachelor of Computer Science)</p>
          </div>
          <div id="bsccsContent" class="collapse">
            <div class="card-body">
            <div class="container">
                <table class="table table-bordered">
                  <thead>
