    ...
    <div class="container"
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="exampleInputEmail1" style="width: 500px;"
                    placeholder="Enter your new password" required>
            </div>
            <div class="mb-3">
                <label for="text" class="form-label">Confirm Password *</label>
                <input type="password" class="form-control" id="exampleInputRollNo"
                    placeholder="Confirm your new password" required name="password">
            ...
            <div class="reset-password">
                <div class="mb-8 text-center">
                    <button type="submit" class="btn btn-primary"
                        style="width: 500px; border-radius: 5px; border-width: 1px; background-color: green; border-color: black;"
