        ...
        <div class="devcontainer" style="padding-top: 80px;">
            ...
            <div class="developers" style="padding-bottom: 50px;">
                <div class="developer">
                    ...
                    <p style="font-size: smaller;">Passionate back-end developer, dedicated to coding, databases, and
                        building robust, scalable systems.</p>

                    <a href="cv/Sonjyoti Rabha-CV.pdf" style="font-size: 15px;" target="_blank"><b>Curriculum Vitae
                            (CV)</b></a>

                    <div class="social-links" style="padding-top: 20px;">
                        <a href="https://twitter.com/SonjyotiR" class="twitter" style="color: black;" target="_blank"><i
                                class="bi bi-twitter"></i></a>
                        <a href="https://www.facebook.com/son.jyoti.58" style="color: black;" class="facebook"
                            target="_blank"><i class="bi bi-facebook"></i></a>
                        <a href="https://www.instagram.com/xonzyoti/" class="instagram" style="color: black;"
                            target="_blank"><i class="bi bi-instagram"></i></a>
                        <a href="https://www.linkedin.com/in/sonjyoti-rabha-5b54861b3/" class="linkedin"
                            style="color: black;" target="_blank"><i class="bi bi-linkedin"></i></a>
                        <a href="https://github.com/sonjyoti" class="github" style="color: black;" target="_blank"><i
                ...
                <div class="developer">
                    ...
                    <p style="font-size: smaller;">Aspiring front-end developer, passionate about creating engaging and
                        user-friendly web experiences.</p>

                    <a href="CV/Subhra_Kinkar-CV.pdf" style="font-size: 15px;" target="_blank"><b>Curriculum Vitae
                            (CV)</b></a>

                    <div class="social-links" style="padding-top: 20px;">
                        <a href="https://twitter.com/Suv3_in" class="twitter" style="color: black;" target="_blank"><i
                                class="bi bi-twitter"></i></a>
                        <a href="https://www.facebook.com/suvrakingar.deka" style="color: black;" class="facebook"
                            target="_blank"><i class="bi bi-facebook"></i></a>
                        <a href="https://www.instagram.com/suv.ra3/" class="instagram" style="color: black;"
                            target="_blank"><i class="bi bi-instagram"></i></a>
                        <a href="https://www.linkedin.com/in/suvki/" class="linkedin" style="color: black;"
                            target="_blank"><i class="bi bi-linkedin"></i></a>
                        <a href="https://github.com/Suvra03" class="github" style="color: black;" target="_blank"><i
                                class="bi bi-github"></i></a>
                    </div>
                </div>
            </div>
