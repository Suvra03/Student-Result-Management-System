                ...
                <div class="content-container"  style="background-color: grey;">
                    ...
                    <div class="main-page" style="background-color: white;">
                        ...
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Manage Subjects' Details -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form method="post" id="selectForm" action="manage_subjects_functions.php">
                                                    ...
                                                    <div style="text-align: center;">
                                                        <button name="submit" class="btn btn-primary" style="width: 400px; border-radius: 5px; border-width: 1px; background-color: green;">Click Here To Submit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
