<?php 
include 'manage_course_functions.php';
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="main-page" style="background-color: white;">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: green; padding-top: 10px; padding-bottom: 10px;">
                                <div>
                                    <h2 class="title" style="color: white; font-size: 20px;"><b>Manage Course</b></h2>
                                </div>
                            </div>
                        </div>
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Manage Course -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="panel">
                                            <div class="panel-title">
                                                <h5 style="padding-left: 15px; padding-top: 10px; font-color: black;"><b>Manage Course -</b></h5>
                                            </div>
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    <thead>
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                ?><strong><?php echo htmlentities("No Courses to show!");?></strong><?php
                                                            }
                                                            else{
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><?php echo htmlentities($row["course_name"]); ?></th>
                                                            <th><?php echo htmlentities($row["course_code"]); ?></th>
                                                            <th><a href="update_course.php?sid=<?php echo htmlentities($row["id"]); ?>"><i class="fa fa-edit" title="Edit Record"></i></a></th>
                                                            <?php
                                                                }}
                                                            ?>
                                                        </tr>
