                            ...
                            <div class="sidebar-nav" >
                                <ul class="side-nav color-white">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create_class.php"><i class="fa fa-bars"></i> <span>Create Class</span></a></li>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                           ...
                                           <li><a href="add_subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Add Subject Combination </span></a></li>
                                           <a href="manage_subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Subject Combination </span></a></li>
                                        </ul>
                                    </li>
                                    <li class="has-children">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <li><a href="change_password.php"><i class="fa fa fa-server"></i> <span> Admin Password Reset</span></a></li>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="main-page" style="background-color: white;">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: green; padding-top: 10px; padding-bottom: 10px;">
                                <div>
                                    <h2 class="title" style="color: white; font-size: 20px;"><b>Admin Password Reset</b></h2>
                                </div>
                            </div>
                        </div>
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;">Reset Your Password -</h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="panel">
                                            <div class="panel-body"  style="border: 2px solid grey; border-radius: 5px;">
                                                <form>
                                                    

                                                    <div style="text-align: center;">
                                                        <button type="submit" class="btn btn-primary" style="width: 400px; border-radius: 5px; border-width: 1px; background-color: green; border-color: black;" name="submit">Click Here To Submit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
