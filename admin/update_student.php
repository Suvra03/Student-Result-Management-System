                            ...
                            <div class="sidebar-nav" >
                                <ul class="side-nav color-white">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create_class.php"><i class="fa fa-bars"></i> <span>Create Course</span></a></li>
                    ...
                    <div class="main-page" style="background-color: white;">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: green; padding-top: 10px; padding-bottom: 10px;">
                                <div>
                                    <h2 class="title" style="color: white; font-size: 20px;"><b>Update Student Information </b></h2>
                                </div>
                            </div>
                        </div>
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Update Student's Details -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                            ...
                                            <div class="panel-body">
                                                <form method="post" id="selectForm">
                                                    ...
                                                    <div style="text-align: center;">
                                                        <button name="submit" class="btn btn-primary" style="width: 400px; border-radius: 5px; border-width: 1px; background-color: green;">Update</a>
                                                    </div><br>
                                                </form>
                                                <?php
