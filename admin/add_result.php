                ...
                <div class="left-sidebar bg-black-300 box-shadow" style="background-color: black;">
                    ...
                    <div class="main-page" style="background-color: white;">
                        ...
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Add Results -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        ...
                                        <div class="panel-body"  style="border-radius: 5px;">
                                                <form>
                                                    ...
                                                    <label for="semester" style="padding-left: 2px;">Students' Roll No:</label>
                                                    <select class="form-control" id="selectCourse" name="semester" required>
                                                        <option value="default">Select Roll No</option>
                                                        <option value="1">UT-211-023-0001</option>
                                                    </select>

                                                    <div class="col-10">
                                                    <label for="name" class="form-label">Maths:</label>
                                                    ...
                                                    <div style="text-align: center;">
                                                        <button type="submit" class="btn btn-primary" style="width: 400px; border-radius: 5px; border-width: 1px; background-color: green;" name="submit">Add Result</button>
                                                    </div><br>

                                                    <div class="alert alert-success left-icon-alert" role="alert">
                                                    <strong>Result Added Succesfully!</strong>
                                                    </div> 
