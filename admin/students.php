                ...
                <div class="left-sidebar bg-black-300 box-shadow" style="background-color: black;">
                    ...
                    <div class="main-page" style="background-color: white;">
                        ...
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Manage Students' -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="panel">
                                            <div class="panel-title">
                                                <h5 style="padding-left: 15px; padding-top: 10px; font-color: black;"><b>Students -</b></h5>
                                            </div>
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    <thead>
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                ?><strong><?php echo htmlentities("No Students to show!");?></strong><?php
                                                            }
                                                            else{
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><?php echo htmlentities($row["roll_id"]); ?></th>
                                                            <th><?php echo htmlentities($row["course_name"]); ?></th>
                                                            <th><?php echo htmlentities($row["semester"]); ?></th>
                                                            <th><a href="update_student.php?std=<?php echo htmlentities($row["id"]); ?>"><i class="fa fa-edit" title="Edit Record"></i></a></th>
                                                            <?php
                                                                }}
                                                            ?>
                                                        </tr>
