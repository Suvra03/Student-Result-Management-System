                ...
                <div class="left-sidebar bg-black-300 box-shadow" style="background-color: black;">
                    ...
                    <div class="main-page" style="background-color: white;">
                        ...
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Create Subjects -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                        ...
                                        <div class="panel-body"  style="border-radius: 5px;">
                                                <form method="post" id="selectForm">
                                                    ...
                                                    <div style="text-align: center;">
                                                        <button type="submit" class="btn btn-primary" style="width: 400px; border-radius: 5px; border-width: 1px; background-color: green;" name="addSubject">Add Subject</button>
                                                    </div><br>
