                ...
                <div class="content-container"  style="background-color: grey;">
                    ...
                    <div class="main-page" style="background-color: white;">
                        ...
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;"><b>Manage Students' Details -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <form method="post" id="selectForm" action="manage_students_functions.php">
