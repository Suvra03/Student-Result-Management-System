                ...
                <div class="main-page" style="background-color: white;">
                    <div class="container-fluid">
                        ...
                        <section class="section">
                            <h4 style="padding-top: 30px; padding-bottom: 20px; padding-left: 10%; color: black;">
                                <b>View
                                    Results -</b></h4><br>
                            <div class="container-fluid">
                                <div class="row">
                                        ...
                                        <div class="panel">
                                            <div class="panel-body" style="border-radius: 5px;">
                                                <form method="post">
                                                    ...
                                                    <select class="form-control" id="selectCourse" name="semester"
                                                        required>
                                                    ...
                                                    <div style="text-align: center;">
                                                        <button type="submit" name="submit" class="btn btn-primary"
                                                            style="width: 750px; border-radius: 3px; border-width: 1px; background-color: green;"><b>Get
                                                                Result</b></button>
                                                    </div><br>
                                                </form>
                                                <?php
