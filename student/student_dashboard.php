                                ...
                                <div class="row">
                                        ...
                                        <div class="card-body" style="font-size: 15px;">
                                            <div class="mb-4" style="font-size: 15px;">
                                                <div style="background-color: white; height: 130px; width: 250px; border-top-right-radius: 12px; border-top-left-radius: 12px; padding-top: 20px; padding-left: 75px;">
                                                    <img src="../logos/profile01.png" class="img-fluid h-20" alt="Uni Logo" style="height: 100px; width: 100px;">
                                                </div>
                                                <div class="pt-2 btn" style="font-size: 15px; color: white;border-radius: 0%; width: 250px; background-color: green; border-bottom-right-radius: 12px; border-bottom-left-radius: 12px;">
                                                    <a class="cool-link" href="manage_profile.php" style="color: #fff; text-decoration: dotted;">Edit Profile</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-left: 40px;">
                                        <div class="card-body" style="font-size: 15px;">
                                            <div class="mb-4" style="font-size: 15px;">
                                                <div style="background-color: white; height: 130px; width: 250px; border-top-right-radius: 12px; border-top-left-radius: 12px; padding-top: 20px; padding-left: 75px;">
                                                    <img src="../logos/resultlogo.png" class="img-fluid h-20" alt="Uni Logo" style="height: 100px; width: 100px;">
                                                </div>
                                                <div class="pt-2 btn" style="font-size: 15px; color: white;border-radius: 0%; width: 250px; background-color: green; border-bottom-right-radius: 12px; border-bottom-left-radius: 12px;">
                                                    <a class="cool-link" href="view_results.php" style="color: #fff; text-decoration: dotted;">View Results</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-left: 30px;">
                                        <div class="card-body" style="font-size: 15px;">
                                            <div class="mb-4" style="font-size: 15px;">
                                                <div style="background-color: white; height: 130px; width: 250px; border-top-right-radius: 12px; border-top-left-radius: 12px; padding-top: 20px; padding-left: 75px;">
                                                    <img src="../logos/noticelogo.png" class="img-fluid h-20" alt="Uni Logo" style="height: 100px; width: 100px;">
                                                </div>
                                                <div class="pt-2 btn" style="font-size: 15px; color: white;border-radius: 0%; width: 250px; background-color: green; border-bottom-right-radius: 12px; border-bottom-left-radius: 12px;">
                                                    <a class="cool-link" href="view_notice.php" style="color: #fff; text-decoration: dotted;">View Updates</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="padding-left: 20px;">
                                        <div class="card-body" style="font-size: 15px;">
                                            <div class="mb-4" style="font-size: 15px;">
                                                <div style="background-color: white; height: 130px; width: 250px; border-top-right-radius: 12px; border-top-left-radius: 12px; padding-top: 20px; padding-left: 75px;">
                                                    <img src="../logos/password.png" class="img-fluid h-20" alt="Uni Logo" style="height: 100px; width: 100px;">
                                                </div>
                                                <div class="pt-2 btn" style="font-size: 15px; color: white;border-radius: 0%; width: 250px; background-color: green; border-bottom-right-radius: 12px; border-bottom-left-radius: 12px;">
                                                    <a class="cool-link" href="change_password.php" style="color: #fff; text-decoration: dotted;">Change Password</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
