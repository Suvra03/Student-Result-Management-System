                        ...
                        <div class="container">
                            ...
                            <div class="col-10">
                                ...
                                <input type="text" class="form-control" id="Name"
                                    placeholder="<?php echo htmlentities($name); ?>" disabled>
                            </div>
                            <div class="col-10">
                                <label for="DOB">Date of birth:</label>
                                <input type="text" class="form-control" id="DOB"
                                    placeholder="<?php echo htmlentities($dob); ?>" disabled>
                            </div>
                            <div class="col-10">
                                <label for="Gender">Gender:</label>
                                <input type="text" class="form-control" id="Gender"
                                    placeholder="<?php echo htmlentities($gender); ?>" disabled>
                            </div>
                            <div class="row">
                                <form method="post">
                                    <div class="col-md-10">
                                        ...
                                        <input type="email" class="form-control" id="Email"
                                            placeholder="<?php echo htmlentities($email); ?>" disabled>
                                    </div>
                                    <div class="col-md-2 d-flex" style="padding-top: 25px;">
                                        <button type="button" class="btn btn-secondary" id="btnEmail"
                                            onclick="enableInputEmail()"
                                            style="width: 160px; border: solid black 2px; background-color: green; color: white;">Edit</button>
                                    </div>
                                </form>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" class="form-control" id="Phone"
                                        placeholder="<?php echo htmlentities($phone); ?>" disabled>
                                </div>
                                <div class="col-md-2 d-flex" style="padding-top: 25px;">
                                    <button type="button" class="btn btn-secondary" id="btnPhone"
                                        onclick="enableInputPhone()"
                                        style="width: 160px; border: solid black 2px; background-color: green; color: white;">Edit</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="col-10">
                                ...
                                <input type="text" class="form-control" id="Address-1"
                                    placeholder="<?php echo htmlentities($address1); ?>" disabled>
                            </div>
                            <div class="col-10">
                                <label for="Address-2" class="form-label">Address Line 2:</label>
                                <input type="text" class="form-control" id="Address-2"
                                    placeholder="<?php echo htmlentities($address2); ?>" disabled>
                            </div>
                            <div class="col-5">
                                <label for="State">State</label>
                                <input type="text" class="form-control" id="State"
                                    placeholder="<?php echo htmlentities($state); ?>" disabled>
                            </div>

                            <div class="col-5">
                                <label for="District">District</label>
                                <input type="text" class="form-control" id="District"
                                    placeholder="<?php echo htmlentities($district); ?>" disabled>
                            </div>

                            <div class="col-5">
                                <label for="Pin" class="form-label">Pincode:</label>
                                <input type="text" class="form-control" id="Pin"
                                    placeholder="<?php echo htmlentities($pincode); ?>" disabled>
                            </div>
                        </div><br><br>
