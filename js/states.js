// Define your list of districts for each state
var districtData = {
    ...
    "AruchanalPradesh": ["Anjaw","Changlang","Dibang Valley","East Kameng","East Siang","Kra Daadi","Kurung Kumey","Lohit","Longding","Lower Dibang Valley","Lower Subansiri","Namsai","Papum Pare","Siang","Tawang","Tirap","Upper Siang","Upper Subansiri","West Kameng","West Siang","Itanagar"],
    ...
    "Poducherry": ["Karaikal","Mahe","Puducherry","Yanam"],
};

// Function to populate the "District" select element based on the selected state
function populateDistricts() {
    var stateSelect = document.getElementById("inputState");
    var districtSelect = document.getElementById("inputDistrict");
    var selectedState = stateSelect.value;

    // Clear the existing options in the "District" select element
    districtSelect.innerHTML = "<option value = ''>Select District</option>";

    // Check if the selected state has districts defined
